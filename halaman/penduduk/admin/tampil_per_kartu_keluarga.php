    ...
    <div class="container-fluid">
        <div class="title-wrapper pt-30">
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <a href="?page=data_sensus&sub_page=penduduk&action=tambah&id_kecamatan=<?= $_GET['id_kecamatan']; ?>&id_periode_sensus=<?= $_GET['id_periode_sensus']; ?>" class="btn btn-primary mb-30">Tambah</a>
                </div>
            </div>
        </div>
