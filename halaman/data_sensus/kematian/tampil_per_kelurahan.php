    ...
    <div class="container-fluid">
        <div class="title-wrapper pt-30">
            <div class="row align-items-center">
                ...
                <?php if ($_SESSION['user']['id_petugas']) : ?>
                    <div class="col-auto">
                        <a href="?page=kecamatan&sub_page=kelurahan&action=tambah_kematian&id_kecamatan=<?= $_GET['id_kecamatan']; ?>&id_kelurahan=<?= $_GET['id_kelurahan']; ?>" class="btn btn-primary mb-30">Tambah</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="fit">
                                                    <div class="d-flex gap-3">
                                                        <div class="action">
                                                            <a href="?page=kecamatan&sub_page=kelurahan&action=detail_per_anggota_keluarga&id_kecamatan=<?= $_GET['id_kecamatan']; ?>&id_kelurahan=<?= $_GET['id_kelurahan']; ?>&id=<?= $row['id']; ?>" class="text-secondary">
                                                        ...
                                                        <div class="action">
                                                            <a href="?page=kecamatan&sub_page=kelurahan&action=ubah_kematian&id_kecamatan=<?= $_GET['id_kecamatan']; ?>&id_kelurahan=<?= $_GET['id_kelurahan']; ?>&id=<?= $row['id']; ?>" class="text-warning">
                                                                <i class="lni lni-pencil"></i>
                                                            </a>
                                                        </div>
                                                        <div class="action">
                                                            <a onclick="return confirm('Yakin?')" href="?page=kecamatan&sub_page=kelurahan&action=hapus_kematian&id_kecamatan=<?= $_GET['id_kecamatan']; ?>&id_kelurahan=<?= $_GET['id_kelurahan']; ?>&id=<?= $row['id']; ?>" class="text-danger">
