<?php
$data = $koneksi->query("SELECT * FROM status_keluarga WHERE id=" . $_GET['id'])->fetch_assoc();
if (isset($_POST['edit'])) {
    $nama = $koneksi->real_escape_string($_POST['nama']);

    if ($koneksi->query("UPDATE status_keluarga SET nama='$nama' WHERE id=" . $_GET['id']))
                        ...
                        <form action="" method="POST">
                            <div class="row">
                                ...
                                <div class="col-12 d-flex justify-content-between">
                                    <a href="?page=master_data&sub_page=status_keluarga&action=tampil" class="main-btn btn-sm secondary-btn btn-hover">Kembali</a>
