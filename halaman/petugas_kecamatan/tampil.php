                ...
                <div class="col">
                    <div class="title mb-30">
                        <?php if (count($periode_sensus)) : ?>
                            <h3>Data Petugas Kecamatan (Periode Sensus <?= $periode_sensus[0]['tahun']; ?>)</h3>
                        <?php else : ?>
                            <h3>Data Petugas Kecamatan</h3>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="col-auto">
                                        ...
                                        <?php if ($result->num_rows) : ?>
                                            <?php while ($row = $result->fetch_assoc()) : ?>
                                                <tr>
                                                    ...
                                                    <td class="fit">
                                                        <div class="action">
                                                            <a href="?page=petugas&sub_page=petugas_kecamatan&action=detail&id_kecamatan=<?= $row['id']; ?>&id_periode_sensus=<?= $periode_sensus[0]['id']; ?>" class="text-secondary">
