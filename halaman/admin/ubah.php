<?php
$data = $koneksi->query("SELECT * FROM pengguna WHERE id=" . $_GET['id'])->fetch_assoc();
if (isset($_POST['edit'])) {
    $username = $koneksi->real_escape_string($_POST['username']);
    $password = $koneksi->real_escape_string($_POST['password']);

    if ($koneksi->query("UPDATE pengguna SET username='$username', password='$password' WHERE id=" . $_GET['id']))
