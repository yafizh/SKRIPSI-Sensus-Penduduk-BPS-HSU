                            ...
                            <div class="row">
                                ...
                                <div class="col-12 d-flex justify-content-end gap-2">
                                    ...
                                    <?php if (isset($_POST['dari_periode_sensus']) && isset($_POST['sampai_periode_sensus'])) : ?>
                                        <?php
                                        $link = "halaman/laporan/cetak/grafik_kematian.php?dari_periode_sensus=" . ($_POST['dari_periode_sensus'] ?? '') . "&sampai_periode_sensus=" . ($_POST['sampai_periode_sensus'] ?? '');
                    ...
                    <div class="col-12">
                        <div class="card-style mb-30">
                            <div class="title d-flex flex-wrap align-items-center justify-content-between">
                                <div class="left">
                                    <h6 class="text-medium mb-30">Grafik Kematian Periode Sensus <?= $_POST['dari_periode_sensus']; ?> - <?= $_POST['sampai_periode_sensus']; ?> <?= isset($_POST['kecamatan']) ? 'Kecamatan ' . $_POST['kecamatan'] : ''; ?> <?= isset($_POST['kelurahan']) ? 'Kelurahan ' . $_POST['kelurahan'] : ''; ?></h6>
                                </div>
                            </div>
                            <div class="chart">
