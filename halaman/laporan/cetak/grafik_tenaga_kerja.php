...
<head>
    ...
    <title>Laporan Grafik Tenaga Kerja</title>
...
<body>
    ...
    $q = "
        ...
        WHERE 
            ...
            AND 
            p.id_jenis_pekerjaan=" . $_GET['id_jenis_pekerjaan'] . "
        ";
    ...
    ?>
    <h4 class="text-center my-3">Laporan Grafik Tenaga Kerja</h4>
    <section class="p-3">
        <div class="row">
            <div class="col-12 col-sm-6 col-lg-3">
                <table class="table">
                    ...
                    <tr>
                        <?php $jenis_pekerjaan = $koneksi->query("SELECT * FROM jenis_pekerjaan WHERE id=" . $_GET['id_jenis_pekerjaan'])->fetch_assoc(); ?>
                        <td class="align-middle td-fit">Tenaga Kerja</td>
                        <td class="pl-5">: <?= $jenis_pekerjaan['nama']; ?></td>
                    </tr>
