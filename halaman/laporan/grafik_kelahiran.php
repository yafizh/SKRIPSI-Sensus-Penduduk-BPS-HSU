            ...
            <div class="row align-items-center">
                <div class="col">
                    <div class="title mb-30">
                        <h3>Laporan Grafik Kelahiran</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12">
                        <div class="card-style mb-30">
                            <div class="title d-flex flex-wrap align-items-center justify-content-between">
                                <div class="left">
                                    <h6 class="text-medium mb-30">Grafik Kelahiran Periode Sensus <?= $_POST['dari_periode_sensus']; ?> - <?= $_POST['sampai_periode_sensus']; ?> <?= isset($_POST['kecamatan']) ? 'Kecamatan ' . $_POST['kecamatan'] : ''; ?> <?= isset($_POST['kelurahan']) ? 'Kelurahan ' . $_POST['kelurahan'] : ''; ?></h6>
                                </div>
                            </div>
                            <div class="chart">
