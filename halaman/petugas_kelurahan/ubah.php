...
if (isset($_POST['edit'])) {
    ...
    try {
        ...
        if ($check->num_rows < 2)
            ...
            $koneksi->query("DELETE FROM `petugas_kelurahan/desa` WHERE id_petugas=" . $data['id_petugas'] . " AND id_kelurahan=" . $data['id_kelurahan/desa']);
            ...
            <div class="row align-items-center">
                <div class="col-md-12 text-center">
                    <div class="title mb-30">
                        <h2>Edit Petugas Kelurahan/Desa</h2>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="select-style-1">
                                        <label>Petugas Kelurahan/Desa</label>
